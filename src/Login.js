              ...
              <div class="card mb-5">
                <div class="card-body d-flex flex-column align-items-center">
                  ...
                  <form class="text-center" method="post" action='/login'>
                    <div class="mb-3"><input class="form-control" type="text" name="user_id" placeholder="ID" /></div>
                    <div class="mb-3"><input class="form-control" type="password" name="pw" placeholder="비밀번호" /></div>
