              ...
              <div class="card mb-5">
                <div class="card-body d-flex flex-column align-items-center">
                  ...
                  <form class="text-center" method="post" onSubmit={handleRegister}>
                    <div class="mb-3">
                      <input class="form-control" type="text" id="user_id" name="user_id" placeholder="아이디" value={userId} onChange={(e) => setUserId(e.target.value)} required />
                    </div>
                    <div class="mb-3">
                      <input class="form-control" type="text" id="user_name" name="user_name" placeholder="닉네임" value={username} onChange={(e) => setUsername(e.target.value)} required />
                      </div>
                    <form>
                    <div class="mb-3">
                      <input class="form-control" type="password" id="pw" name="pw" autocomplete="off" placeholder="비밀번호" value={password} onChange={(e) => setPassword(e.target.value)} required />
                    ...
                    <div class="mb-3">
                      <input class="form-control" type="password" id="pw2" name="pw2" autocomplete="off" placeholder="비밀번호 재입력" value={passwordCheck} onChange={(e) => setPasswordCheck(e.target.value)} required />
                      </div>
                    <div class="mb-3">
                      <button class="btn btn-primary d-block w-100" type="submit">회원 가입</button>
                      </div>
