            ...
            <div className="row">
              <div className="col-md-10 col-xl-12 offset-xl-1 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                <div>
                  ...
                  <br />
                  <a href="https://github.com/MediChat-ai/android/releases/download/v1.02/MediChat.apk" target="_blank" rel="noreferrer"><button className="btn btn-primary fs-5 py-2 px-4" type="button">앱 다운로드</button></a>
                </div>
              </div>
            </div>
          </div>
